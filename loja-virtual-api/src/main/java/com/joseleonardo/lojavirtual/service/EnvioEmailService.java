...
public class EnvioEmailService {
	...
	private String userName = "jlcb.lojavirtual@gmail.com";
	private String senha = "ottd otpz tsqp bpgc";
	...
	public void enviarEmailHtml(String assunto, String menssagem, String emailDestino) 
		...
		message.setFrom(new InternetAddress(userName, "José Leonardo - Loja Virtual", "UTF-8"));
