...
public class AsaasPagamentoCobrancaGeradaCartaoCreditoDTO implements Serializable {
	...
	// Representa as informações do cartão de crédito associado à cobrança gerada no
	// sistema da Asaas
	private AsaasPagamentoCobrancaGeradaCreditCardInfoDTO creditCard = new AsaasPagamentoCobrancaGeradaCreditCardInfoDTO();
	...
	public AsaasPagamentoCobrancaGeradaCreditCardInfoDTO getCreditCard() {
		return creditCard;
	}

	public void setCreditCard(AsaasPagamentoCobrancaGeradaCreditCardInfoDTO creditCard) {
