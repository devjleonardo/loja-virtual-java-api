...
public class GetResponseEmailMarketingCampaignListDTO implements Serializable {
	...
	public String toString() {
		return "CampanhaDTO [description=" + description + ", campaignId=" + campaignId + ", name=" + name
